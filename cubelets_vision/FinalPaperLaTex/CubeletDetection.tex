...
\begin{abstract}
%\boldmath
In this paper we seek to describe a means to detect and localize structures created from Modular Robotics Cubelets using a combination of template matching and depth data from an RGB-D sensor, such as the Xbox Kinect.
\end{abstract}
