...
[6pt]
The algorithm was run on three different data sets, each generated at different portions of the development process.  The first data set was taken with a a webcam, with the cubes sitting on a wood panel background.  The second data set was again taken with a webcam, but with the cubes sitting on a white-papered background.  The final data set was taken with a kinect sensor's camera, over a clean table background.
